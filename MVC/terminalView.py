...
class View:
    agents = [deepQ.DeepQ, qLearning.QLearning, drqn.DRQN, adrqn.ADRQN, sarsa, deepQ.DeepQPrioritized, deepQ.DeepQHindsight, drqn.DRQNPrioritized,  drqn.DRQNHindsight,adrqn.ADRQNPrioritized,adrqn.ADRQNHindsight]
