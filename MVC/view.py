...
class View:
    ...
    def __init__(self, listener):
        ...
        self.mMenuRun.add_command(label="Save Agent", command=pw.save)
        self.mMenuRun.add_command(label="Load Agent", command=pw.load)
        self.mMenuRun.add_command(label="Reset", command=pw.reset)
        self.mMenuRun.add_command(label="Save Results", command=pw.saveResults)
